...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype.clickHandler = function (event) {
        if ($(event.target).hasClass('node-tree') || $(event.target).hasClass('icon')) {
	...
	Tree.prototype.buildTree = function (nodes, level) {
		...
		$.each(nodes, function addNodes(id, node) {
            ...
            //Add buttons
            if (node.ddbutton) {
                var $btn = $(_this.template.ddbutton).html(node.ddbutton.title).append(_this.template.ddbuttonspan);
                var $ddbutton = $(_this.template.dddiv).append($btn);
                var $ddlist = $(_this.template.ddmenu);
                ...
                $.each(node.ddbutton.actions, function addElement (id, action){
                    ...
                    if (action.type == 'separator') {
                        ...
                        $ddlist.append($separator);
                    }
                });
                $ddbutton.append($ddlist);
                treeItem.append($ddbutton);
            }
	...
	Tree.prototype.template = {
        ...
        //dropdown elements
        dddiv: '<div class="dropdown treeview-dropdown"></div>',
