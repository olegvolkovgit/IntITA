...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins = 'eqneditor,pastebase64,youtube,audio,skipWord1,skipWord0,' +
        ...
        'c_edpnou,c_bank_name,c_bank_code,c_legal_address,c_contacts,c_checking_account,c_license,c_license_issued,c_license_issued_date,u_user_phone,u_user_email';
