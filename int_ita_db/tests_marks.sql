...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='mark: 0 - failed, 1 - success';

-- Dumping data for table int_ita_db.tests_marks: ~37 rows (approximately)
