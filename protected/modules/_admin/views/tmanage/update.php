...
?>
    ...
    <br>
    <button type="button" class="btn btn-link">
        <a href="<?php echo Yii::app()->createUrl('/_admin/tmanage/view', array('id' => $model->teacher_id)); ?>">
    ...
    <div class="page-header">
        <h2>Оновлення інформації про
            викладача <?php echo "{$model->last_name} {$model->first_name} {$model->middle_name}"; ?>
        </h2>
    </div>
