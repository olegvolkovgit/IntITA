...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo StaticFilesHelper::bootstrapPath('bootstrap/dist/css/bootstrap.css'); ?>" rel="stylesheet">
    <link href="<?php echo StaticFilesHelper::bootstrapPath('bootstrap/dist/css/bootstrap-theme.css'); ?>" rel="stylesheet">

    <link href="<?php echo StaticFilesHelper::bootstrapPath('bootstrap/dist/css/bootstrap.min.css'); ?>" rel="stylesheet">
    <!-- MetisMenu CSS -->
    <link href="<?php echo StaticFilesHelper::bootstrapPath('metisMenu/dist/metisMenu.min.css');?>" rel="stylesheet">
    <!-- Timeline CSS -->
    <link href="<?php echo StaticFilesHelper::bootstrapDistPath('css/timeline.css');?>" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo StaticFilesHelper::bootstrapDistPath('css/sb-admin-2.css');?>" rel="stylesheet">
    <!-- Morris Charts CSS -->
    <link href="<?php echo StaticFilesHelper::bootstrapPath('morrisjs/morris.css');?>" rel="stylesheet">
    <!-- Custom Fonts -->
    <link href="<?php echo StaticFilesHelper::bootstrapPath('font-awesome/css/font-awesome.min.css');?>" rel="stylesheet" type="text/css">
...
<!-- jQuery -->
<script src="<?php echo StaticFilesHelper::bootstrapPath('jquery/dist/jquery.min.js');?>"></script>
<!-- Bootstrap Core JavaScript -->
<script src="<?php echo StaticFilesHelper::bootstrapPath('bootstrap/dist/js/bootstrap.min.js');?>"></script>
<!-- Metis Menu Plugin JavaScript -->
<script src="<?php echo StaticFilesHelper::bootstrapPath('metisMenu/dist/metisMenu.min.js');?>"></script>
<script src="<?php echo StaticFilesHelper::bootstrapPath('raphael/raphael-min.js');?>"></script>

<!-- Custom Theme JavaScript -->
<script src="<?php echo StaticFilesHelper::bootstrapDistPath('js/sb-admin-2.js');?>"></script>
...
<script src="<?php echo StaticFilesHelper::bootstrapPath('morrisjs/morris.min.js');?>"></script>
</html>
