        ...
        <form role="form">
            <div class="form-group" id="receiver">
                ...
                <em>Зверніть увагу, що деяких користувачів може не бути в списку. В списку немає користувачів, в
                    яких вже є права supervisor'а.</em>
                <br>
            </div>

            <button class="btn btn-primary"
                    ng-click="assignRole('<?php echo Yii::app()->createUrl("/_teacher/_admin/users/assignRole"); ?>','super_visor');">
                Призначити supervisor'ом
            </button>
...
<script>
    var users = new Bloodhound({
        ...
        remote: {
            url: basePath + '/_teacher/_admin/users/usersAddForm?role=super_visor&query=%QUERY',
            wildcard: '%QUERY',
