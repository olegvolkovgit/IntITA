    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="dataTable_wrapper">
                <table class="table table-striped table-bordered table-hover" id="teacherConsultantsTable" datatable="ng" dt-options="dtOptions">
                    <thead>
                    <tr>
                        <th>ПІБ</th>
                        <th>Email</th>
                    ...
                    <tbody>
                    <tr ng-repeat="row in teacherConsultantsList">
                        ...
                        <td><a ng-click="cancelRole(row.cancel,'teacher_consultant',row.id)"><i class="fa fa-trash fa-fw"></i></a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
