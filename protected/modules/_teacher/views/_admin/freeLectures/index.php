            ...
            <div class="dataTable_wrapper">
                ...
                <span>Пошук:  <input class="form-control" type="text" placeholder="" ng-model="search" ng-change="searchLectures()"></span>
                    ...
                    <tr ng-repeat="row in $data">
                        <td sortable="'module.title_ua'" data-title="'Модуль'" style="width: "><a href="/module/ua/{{row.module.module_ID}}">{{row.module.title_ua}}</td>
                        <td sortable="'t.order'" data-title="'Порядок у модулі'" style="width: ">{{row.order}}</td>
                        <td sortable="'t.title_ua'" data-title="'Назва'" ><a href="/module/ua/{{row.module.module_ID}}/{{row.order}}">{{row.title_ua}}</a></td>
