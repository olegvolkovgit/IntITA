...
<form class="form-horizontal" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" rows="5" id="forWhomEn" placeholder="для кого"><?=$model->for_whom_en;?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-2" for="whatYouLearnEn">Що ти вивчиш (англ.):</label>
        <div class="col-sm-10">
            <textarea class="form-control" rows="5" id="whatYouLearnEn" placeholder="що ти вивчиш"><?=$model->what_you_learn_en;?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-2" for="whatYouGetEn">Що ти отримаєш (англ.):</label>
        <div class="col-sm-10">
             <textarea class="form-control" rows="5" id="whatYouGetEn" placeholder="що ти отримаєш"><?=$model->what_you_get_en;?></textarea>
        </div>
    </div>
    <div class="form-group">
