    ...
    <form role="form">
        <fieldset>
            <div class="form-group">
                ...
                <input type="text" size="135" ng-model="courseSelected" placeholder="додати курс" uib-typeahead="item.title for item in getCourses($viewValue)" typeahead-loading="loadingCourses" typeahead-no-results="noResults" class="form-control"  typeahead-on-select="onSelect($item)"/>
