        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alias" placeholder="Псевдонім" value="<?=$model->alias?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="number">Номер модуля:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="number" placeholder="Номер модуля" value="<?=$model->number?>" required>
                    </div>
                </div>
                <div class="form-group">
