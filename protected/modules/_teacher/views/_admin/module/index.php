<div ng-controller="modulesTableCtrl">
    <div class="col-lg-12" >
                ...
                <div class="dataTable_wrapper">
                    <table ng-table="modulesTable" class="table table-striped table-bordered table-hover">
                        ...
                        <tr ng-repeat="row in $data">
                            ...
                            <td data-title="'Призначити'"><button type="button" class="btn btn-outline btn-success btn-sm" ng-click="changeView('module/addAuthor/'+row.module_ID)">автора</></td>
                        </tr>
                    </table>
                </div>
            </div>
