    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="dataTable_wrapper">
                <table ng-table="ModulesWithoutVideoAndTests" class="table table-striped table-bordered table-hover" id="statusOfModulesTable">
                    <colgroup>
                        <col width="30%"/>
                        <col width="12%"/>
                        <col width="12%"/>
                    ...
                    <tr ng-repeat="row in $data">
                        <td style="width:30%;" data-title="'Назва курсу'" sortable="'title'" filter="{title: 'text'}"><a href="#/content_manager/statusOfModules/{{row.id}}">{{row.title}} ({{row.language}})</a></td>
