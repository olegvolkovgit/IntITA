<div class="panel-body" ng-controller="groupAccessCtrl">
    <div class="row">
        <div class="formMargin">
            <div class="col-lg-8">
                <form autocomplete="off" ng-submit="sendGroupAccessToContent('<?php echo $scenario ?>',selectedGroup.id, selectedContent.id, end_date, 'course');" name="groupAccessForm" novalidate>
                    ...
                    <div class="form-group">
                        <label>Курс*:</label>
                        <input autocomplete="off" type="text" name="course" size="50" ng-model="serviceSelected" ng-model-options="{ debounce: 1000 }"
                               placeholder="Назва курсу" uib-typeahead="item.title for item in getCourses($viewValue) | limitTo : 10"
                               typeahead-no-results="noResultsCourse"  typeahead-on-select="onSelectService($item)"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="end_date" ng-model="end_date" name="end_date"
