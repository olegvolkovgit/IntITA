<div class="col-lg-12">
    <br>
<!--    <a type="button" class="btn btn-primary" ng-href="#/admin/users/addrole/director">-->
...
<!--    </a>-->
    <br>
    <br>
    <div class="panel panel-default" ng-controller="directorsTableCtrl">
        <div class="panel-body">
            <div class="dataTable_wrapper">
                <table ng-table="directorsTableParams" class="table table-bordered table-striped table-condensed">
                    <tr ng-repeat="row in $data track by $index">
                        ...
                        <td data-title="'Скасувати роль'"><a ng-if="!row.end_date" ng-click="cancelRole(row.id_user,'director')"><i class="fa fa-trash fa-fw"></i></a></td>
                    </tr>
                </table>
            </div>
        </div>
