    ...
    <div class="panel panel-default" ng-controller="superAdminsTableCtrl">
        <div class="panel-body">
            <div class="dataTable_wrapper">
                <table ng-table="superAdminsTableParams" class="table table-bordered table-striped table-condensed">
                    <tr ng-repeat="row in $data track by $index">
                        ...
                        <td data-title="'Скасувати роль'"><a ng-if="!row.end_date" ng-click="cancelRole(row.id_user,'super_admin')"><i class="fa fa-trash fa-fw"></i></a></td>
                    </tr>
                </table>
            </div>
        </div>
