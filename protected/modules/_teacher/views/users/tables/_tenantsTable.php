...
<a title="Експорт" class="glyphicon glyphicon-floppy-disk btn btn-primary pull-right" style="margin: 5px;"
   href="/_teacher/_admin/users/export/type/tenants">
</a>
<br>
<br>
<div class="panel panel-default" ng-controller="tenantsTableCtrl">
            ...
            <table ng-table="tenantsTableParams" class="table table-bordered table-striped table-condensed">
                ...
                <tr ng-repeat="row in $data track by $index">
                    ...
                    <td data-title="''">
                        ...
                        <!--                        <a ng-if="!row.end_date" ng-click="cancelRole(row.id_user,'tenant')"><i class="fa fa-trash fa-fw"></i></a>-->
                    </td>
                </tr>
            </table>
        </div>
