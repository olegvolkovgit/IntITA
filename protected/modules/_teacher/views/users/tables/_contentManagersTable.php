...
<a title="Експорт" class="glyphicon glyphicon-floppy-disk btn btn-primary pull-right" style="margin: 5px;"
   href="/_teacher/_admin/users/export/type/contentManagers">
</a>
<br>
<br>
<div class="panel panel-default" ng-controller="contentManagersTableCtrl" organization="<?php echo $organization ?>">
                ...
                <tr ng-repeat="row in $data track by $index">
                    ...
                    <td data-title="''">
                        ...
                        <?php if (Yii::app()->user->model->isAdmin() && $organization) { ?>
                            <a ng-if="!row.end_date" ng-click="cancelLocalRole(row.id_user,'content_manager')"><i class="fa fa-trash fa-fw"></i></a>
                        <?php } ?>
                    </td>
                </tr>
            </table>
