<div class="panel-body" ng-controller="careerStartCtrl">
    <div class="row">
        <div class="formMargin">
            <div class="col-lg-8">
                <form autocomplete="off" ng-submit="editCareer();" name="editCareerForm"  novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input name="title_ua" class="form-control" ng-model="career.title_ru" required maxlength="128" size="50">
                    ...
                    <div class="form-group">
                        ...
                        <div ng-cloak  class="clientValidationError" ng-show="editCareerForm['title_ua'].$dirty && editCareerForm['title_en'].$invalid">
                            <span ng-show="editCareerForm['title_en'].$error.required"><?php echo Yii::t('error','0268') ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" ng-disabled="editCareerForm.$invalid">Зберегти
                        </button>
