<div class="panel-body" ng-controller="taskTypeCtrl">
    <div class="row">
        <div class="formMargin">
            <div class="col-lg-8">
                <form autocomplete="off" ng-submit="editTaskType();" name="editTaskTypeForm"  novalidate>
                    <div class="form-group">
                        <input type="hidden" ng-model="taskType.id" >
                    ...
                    <div class="form-group">
                        ...
                        <input name="title_ua" class="form-control" ng-model="taskType.title_ru" required maxlength="128" size="50">
                    ...
                    <div class="form-group">
                        ...
                        <div ng-cloak  class="clientValidationError" ng-show="editTaskTypeForm['title_ua'].$dirty && editTaskTypeForm['title_en'].$invalid">
                            <span ng-show="editTaskTypeForm['title_en'].$error.required"><?php echo Yii::t('error','0268') ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" ng-disabled="editTaskTypeForm.$invalid">Зберегти
                        </button>
