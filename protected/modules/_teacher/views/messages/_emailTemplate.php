...
<div class="container" style="width:100%; background-color: #ebebeb">
    <div class="contant"  style="width:600px;margin:0 auto; padding-top:30px;">
        ...
        <table border="0" bgcolor="#ffffff" width="100%"">
            <tr>
                <td width="60px;"></td>
                <td width="480px; " height="200px;" ><span>Шановний <b>user</b>!</span>
                   <br> В цьому блоці буде контент.</td>
                <td width="60px;"></td>
            </tr>
            <tr>
                <td width="60px;"></td>
                <td style=" border-top:1px solid #7F7F7F;padding-top: 10px;">З повагою,<br>
                    <a href="http://intita.com" style="color: #4b75a4; font: 18px Arial, sans-serif; line-height: 12px; -webkit-text-size-adjust:none; display: block;" target="_blank">http://intita.com</a><br>
                   ...
                   <span style="color: #333333; font: 10px Arial, sans-serif; line-height: 10px; -webkit-text-size-adjust:none; display: block;"> ел. пошта:<a href="mailto:intita.hr@gmail.com" target="_blank" style=""> intita.hr@gmail.com</a>.</span>
                    <span style="color: #333333; font: 10px Arial, sans-serif; line-height: 10px; -webkit-text-size-adjust:none; display: block; padding-bottom:20px;">скайп: int.ita</span></td>
                <td width="60px;"></td>
            </tr>
        </table>
        ...
        <table border="0" bgcolor="#ebebeb" width="100%"">
            <tr bgcolor="#ebebeb">
                ...
                <td  style="border-color:#ebebeb">
                    <br>
                    <span style="color: #7F7F7F; font-family:Arial, sans-serif; font-size: 12px; line-height: 20px; -webkit-text-size-adjust:none; display: block;">Ви отримали це повідомлення, так як адреса <a href="mailto:user@gmail.com" target="_blank" style="">user@gmail.com</a> пов'язана з обліковим записом, зареєстрованим на Intita.com.ua.</span><br>
