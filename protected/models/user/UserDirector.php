...
/**
 * This is the model class for table "user_director".
 *
 * The followings are the available columns in table 'user_director':
 ...
 */
class UserDirector extends CActiveRecord
{
	/**
	 ...
	 * @return UserDirector the static model class
	 */
	...
	public static function directorArray(){
		$criteria = new CDbCriteria();
		$criteria->distinct = true;
		$criteria->addCondition('end_date IS NULL');
		return UserDirector::model()->with('user')->findAll($criteria);
	}
}