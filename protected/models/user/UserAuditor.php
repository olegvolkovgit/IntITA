...
/**
 * This is the model class for table "user_auditor".
 *
 * The followings are the available columns in table 'user_auditor':
 ...
 */
class UserAuditor extends CActiveRecord
{
	/**
	 ...
	 * @return UserAuditor the static model class
	 */
	...
	public static function auditorArray(){
		$criteria = new CDbCriteria();
		$criteria->distinct = true;
		$criteria->addCondition('end_date IS NULL');
		return UserAuditor::model()->with('user')->findAll($criteria);
	}
}