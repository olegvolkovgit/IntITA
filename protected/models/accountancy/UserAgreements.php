 ...
 * @property PaymentSchema $paymentScheme
 * @property Service $service
 */
abstract class UserAgreements extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'internalPays' => array(self::HAS_MANY, 'InternalPays', 'agreement_id'),
			'user' => array(self::BELONGS_TO, 'User', 'user_id'),
			'approvalUser' => array(self::BELONGS_TO, 'User', 'approval_user'),
			'cancelUser' => array(self::BELONGS_TO, 'User', 'cancel_user'),
			'paymentScheme' => array(self::BELONGS_TO, 'PaymentSchema', 'payment_scheme'),
