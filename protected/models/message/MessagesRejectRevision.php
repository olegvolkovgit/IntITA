...
/**
 * This is the model class for table "messages_reject_revision".
 *
 * The followings are the available columns in table 'messages_reject_revision':
 ...
 */
class MessagesRejectRevision extends CActiveRecord /*extends Messages*/ implements IMessage
{
	private $message;
	...
	private $receiver;
    private $revision;
	const TYPE = MessagesType::REJECT_REVISION;
	/**
	 * @return string the associated database table name
	 */
	public function tableName()
	{
		return 'messages_reject_revision';
	}
    ...
    public function build(StudentReg $userRejected, RevisionLecture $revision, $comment = "", $chained = null, $original = null)
    {
    ...
    public function subject(){
        return "Ревізію №".$this->id_revision." відхилено";
    }
