...
class Module extends CActiveRecord implements IBillableObject
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('for_whom, what_you_learn, what_you_get, days_in_week, hours_in_day, level,days_in_week, hours_in_day, level, status, understand_rating, interesting_rating, accessibility_rating', 'safe'),
