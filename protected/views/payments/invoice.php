...
<link rel="stylesheet" href="<?php echo StaticFilesHelper::fullPathTo('css', 'bower_components/bootstrap/dist/css/bootstrap-theme.css'); ?>">
...
<div class="container">
    <div class="row">
        ...
        <div>
            ...
            <br>
            <br>
            <?php if (isset($_GET['nolayout']) && $_GET['nolayout'] == 'print') { ?>
                <script>
                    $(window).load(
                        function () {
                            window.print();
