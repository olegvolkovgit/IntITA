...
<?php if (!Yii::app()->user->isGuest) { ?>
    ...
    <style type="text/css">
        ...
        .handle{
            position:absolute;top: 15px;left: 50px;width: calc(100% - 120px);height: 35px;background: none;color:#fff;cursor: move;
        }
