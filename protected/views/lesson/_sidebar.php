...
<div id="sidebarLesson">
    ...
    <p><!-- mibew button --><a id="mibew-agent-button" href="http://intita.itatests.com/mibew/chat?locale=<?=$_SESSION['lg']?>&amp;style=default" target="_blank" onclick="Mibew.Objects.ChatPopups['55266d9dbb0cc4a'].open();return false;"><img src="http://intita.itatests.com/mibew/b?i=mblue&amp;lang=<?=$_SESSION['lg']?>" border="0" alt="" /></a><script type="text/javascript" src="http://intita.itatests.com/mibew/js/compiled/chat_popup.js"></script><script type="text/javascript">Mibew.ChatPopup.init({"id":"55266d9dbb0cc4a","url":"http:\/\/intita.itatests.com\/mibew\/chat?locale=<?=$_SESSION['lg']?>&style=default","preferIFrame":true,"modSecurity":false,"height":480,"width":640,"resizable":true,"styleLoader":"http:\/\/intita.itatests.com\/mibew\/chat\/style\/popup\/default"});</script><!-- / mibew button --></a></p>
</div>
<!--navigation vertical-->