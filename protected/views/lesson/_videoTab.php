...
if ($page->video){
?>
<div class="video" ng-click=startLogVideo() start-video='<iframe width="750" height="380" src="<?php echo $page->getLecturePageVideo();?>?rel=0&autoplay=1" frameborder="0" allowfullscreen></iframe>' >
