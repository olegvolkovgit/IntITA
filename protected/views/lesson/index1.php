...
Yii::app()->clientScript->registerMetaTag( StaticFilesHelper::createPath('image', 'lecture', $lecture->image), null, null, array('property' => "og:image"));
?>
<div id="sharing">
    <div class="share42init" data-top1="75" data-top2="110" data-margin="15"
         ...
         data-image="<?php echo StaticFilesHelper::createPath('image', 'lecture', $lecture->image); ?>"
