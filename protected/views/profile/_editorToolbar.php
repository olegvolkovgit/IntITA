...
<div class="imperaviSimple" id="<?php echo $order; ?>">
    ...
    <div class="btns-imperaviSimple" style="width: 100%; height: 30px; border: solid 0px black; margin-bottom: 10px;">
        ...
        <img src="<?php echo Yii::app()->request->baseUrl; ?>/IntITA/images/icons/edt_30px.png" class="icons">
    </div>
    <div class="btn-cancel-ImperaviSimple"
        ...
        <img src="<?php echo Yii::app()->request->baseUrl; ?>/IntITA/images/icons/cls_30px.png" class="icons">
    </div>
    <div class="btn-save-ImperaviSimple"
        ...
        <img src="<?php echo Yii::app()->request->baseUrl; ?>/IntITA/images/icons/sv_30px.png" class="icons">
    </div>
</div>
