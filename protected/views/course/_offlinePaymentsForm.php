                    ...
                    <tr>
                        <td>
                            <div class="numbers" id="numbersFirstOffline">
                                <span class="coursePriceStatus1"><?php echo Yii::t('courses', '0322') . sprintf ("%01.2f", round($price, 2)); ?></span>
                                &nbsp
                                <span class="coursePriceStatus2">
                                    <?php echo Yii::t('courses', '0322') . sprintf ("%01.2f", round(PaymentHelper::discountedPrice($price, 30), 2)); ?>
                                </span>
                                <span id="discount">
