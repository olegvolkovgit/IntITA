...
<span>
    ...
    <?php } else {?>
        <table class="mainPay">
            <tr>
                <td class="icoPay">
                    <img class="icoNoCheck" src="<?php echo StaticFilesHelper::createPath('image', 'course', 'calendar.png');?>">
                    <img class="icoCheck" src="<?php echo StaticFilesHelper::createPath('image', 'course', 'checkCalendar.png');?>">
                </td>
                <td>
                    <table>
                        <tr>
        ...
        Yii::t('module', '0218') . ' х 12 ' . Yii::t('course', '0323').' = ';?><b>
