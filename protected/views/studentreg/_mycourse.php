    ...
    <table>
        <tr>
            <td>
                ...
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/course/index/1/"><span class="colorP">"Апгрейд головного мозку" </span></a>
            </td>
            <td>
...
<div class="profileModule">
    <p><?php echo Yii::t('lecture', '0072'); ?></br> <a href="<?php echo Yii::app()->request->baseUrl; ?>/module/?idModule=1"><span class="colorP">Модуль 4. Модульне око, модульний ніс</span></a></p>
</div>
<div class="profileLesson">
    <p><?php echo Yii::t('lecture', '0073'); ?></br> <a href="<?php echo Yii::app()->request->baseUrl; ?>/lesson/index/1/"><span class="colorP">Заняття 6. Повторіння мать учіння</span></a></p>
</div>
    ...
    <table>
        <tr>
            <td>
                ...
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/course/index/2/"><span class="colorP">"Як прокачати ельфа до 81-го рівня" </span></a>
            </td>
            <td>
    ...
    <table>
        <tr>
            <td>
                ...
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/course/index/3/"><span class="colorP">"Відкрий у собі гобліна"</span></a>
            </td>
            <td>
