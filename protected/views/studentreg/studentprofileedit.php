            ...
            <div class="tabsContent">
                <div id="mainreg">
                    <div class="row">
                        ...
                        <?php echo $form->textField($model, 'firstName', array('ng-init' => "dataForm.firstName='$post->firstName'", 'maxlength' => 20, 'class' => 'indicator', 'data-source' => Yii::t('edit', '0621'), 'ng-model' => "dataForm.firstName", 'ng-pattern' => '/^[a-zа-яіїёA-ZА-ЯІЇЁєЄ\s\'’]+$/')); ?>
                    ...
                    <div class="row">
                        ...
                        <?php echo $form->textField($model, 'secondName', array('ng-init' => "dataForm.secondName='$post->secondName'", 'maxlength' => 20, 'class' => 'indicator', 'data-source' => Yii::t('edit', '0622'), 'ng-model' => "dataForm.secondName", 'ng-pattern' => '/^[a-zа-яіїёA-ZА-ЯІЇЁєЄ\s\'’]+$/')); ?>
                    ...
                    <div class="row">
                        ...
                        <?php echo $form->textField($model, 'nickname', array('ng-init' => "dataForm.nickname='$post->nickname'", 'maxlength' => 20, 'class' => 'indicator', 'ng-model' => "dataForm.nickname", 'data-source' => Yii::t('edit', '0623'))); ?>
                    ...
                    <div class="row">
                        ...
                        <?php echo $form->textField($model, 'phone', array('ng-init' => "dataForm.phone='$post->phone'",'ng-keyup'=>"modelWatch('dataForm.phone')",'model-watch'=>'phone', 'ng-model' => "dataForm.phone", 'class' => 'phone indicator', 'maxlength' => 15, 'minlength' => 15, 'data-source' => Yii::t('edit', '0625'))); ?>
                ...
                <div id="addreg">
                    ...
                    <div class="row">
                        ...
                        <?php echo $form->textField($model, 'address', array('ng-init' => "dataForm.address='$post->address'", 'ng-model' => "dataForm.address", 'maxlength' => 100, 'class' => 'indicator', 'data-source' => Yii::t('edit', '0626'))); ?>
                        <span><?php echo $form->error($model, 'address'); ?></span>
                    </div>
                    <div class="row">
                        <?php echo $form->label($model, 'education'); ?>
                        <?php echo $form->textField($model, 'education', array('ng-init' => "dataForm.education='$post->education'", 'ng-model' => "dataForm.education", 'maxlength' => 100, 'class' => 'indicator', 'data-source' => Yii::t('edit', '0627'))); ?>
                        <span><?php echo $form->error($model, 'education'); ?></span>
                    </div>

                    <div class="row">
                        <?php echo $form->label($model, 'aboutMy'); ?>
                        <?php echo $form->textArea($model, 'aboutMy', array('ng-init' => "dataForm.aboutMy='$post->aboutMy'", 'ng-model' => "dataForm.aboutMy", 'maxlength' => 500, 'class' => 'indicator', 'data-source' => Yii::t('edit', '0628'))); ?>
                    ...
                    <div class="row">
                        ...
                        <?php echo $form->textField($model, 'skype', array('ng-init' => "dataForm.skype='$post->skype'", 'ng-model' => "dataForm.skype", 'maxlength' => 50, 'class' => 'indicator', 'data-source' => 'Skype')); ?>
