...
class m160430_053645_create_vc_skip_task_table extends CDbMigration
{
	public function up()
	{
        $this->createTable('vc_skip_task', [
            ...
            'question' => 'INT(10) NOT NULL',   //id_lecture_element
            ...
            'CONSTRAINT `FK_vc_skip_task_question_vc_lecture_element` FOREIGN KEY (`question`) REFERENCES `vc_lecture_element` (`id`)',
        ]);
	}
