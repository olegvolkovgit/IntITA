...
) ENGINE=InnoDB AUTO_INCREMENT=967 DEFAULT CHARSET=utf8 COMMENT='Chapters and other lecture''s resources ';

-- Dumping data for table intita.lecture_element: ~734 rows (approximately)
...
INSERT INTO `lecture_element` (`id_block`, `id_lecture`, `block_order`, `id_type`, `html_block`) VALUES
	...
	(340, 117, 1, 2, '//www.youtube.com/embed/V3x2cHHEaKY'),
	(341, 117, 7, 2, '//www.youtube.com/embed/yUtpOcX74ow'),
	(343, 134, 1, 10, '\\[\\AA\\]\r'),
	...
	(393, 117, 4, 12, 'Що потрібно, щоб стати кваліфікованим програмістом?'),
	(394, 117, 8, 12, 'Знання яких мов є життєво важливим для роботи програміста?'),
	(395, 117, 11, 2, '//www.youtube.com/embed/Jsdn15AH4v4'),
	(396, 117, 14, 2, '//www.youtube.com/embed/DEtHp4ZncDU'),
	(397, 117, 15, 12, 'Програма має бути:'),
	(398, 117, 18, 2, '//www.youtube.com/embed/tdsjQYP2TUA'),
	(399, 117, 19, 12, 'До якого етапу відносится процес процес перетворення алгоритму на зрозумілу комп’ютері мову?'),
	(400, 117, 20, 6, '<p> Що таке, на Вашу думку, програмування? Чому Вас це цікавить.?</p>'),
	...
	(955, 195, 1, 1, '<p>рукуяя</p>'),
	(956, 117, 21, 10, '\\[\\mathfrak{\\mu \\mu \\tau \\nu \\rho \\mu \\ae \\measuredangle \\measuredangle \\measuredangle }\\]\r\n'),
	(957, 117, 22, 10, '\\[\\varepsilon \\varpi \\varpi \\varrho \\nu \\tau \\varpi \\varpi\\]\r\n'),
	(958, 117, 23, 3, '<p>sgnbskjngvsljn</p>'),
	(959, 195, 2, 3, '<p>gsgsgsgr</p>'),
	(960, 195, 3, 1, '<p>page 2</p>'),
	(961, 195, 4, 1, '<p>page 3</p>'),
	(962, 195, 5, 1, '<p>page 4</p>'),
	(963, 195, 6, 1, '<p>page 5</p>'),
	(966, 117, 24, 12, 'nTCN'),
	(967, 117, 0, 2, '//www.youtube.com/embed/W8dhtHMPWWI'),
	(968, 117, 0, 2, '//www.youtube.com/embed/W8dhtHMPWWI'),
	(969, 117, 0, 2, '//www.youtube.com/embed/W8dhtHMPWWI'),
	(970, 117, 0, 2, '//www.youtube.com/embed/aRo5QkEQ7RE'),
	(971, 117, 29, 12, 'drgdrg'),
	(972, 117, 30, 12, 'dsvfs'),
	(973, 117, 31, 12, 'yrs56yh');
...
INSERT INTO `lecture_page` (`id`, `id_lecture`, `page_title`, `page_order`, `video`, `quiz`) VALUES
	...
	(2, 117, 'Що потрібно щоб стати програмістом', 3, 341, 394),
	(3, 117, 'Що таке мова програмування', 2, 395, NULL),
	(4, 117, 'Якою має бути програма?', 5, 396, 397),
	(5, 117, 'Етапи програмування', 4, 398, 400),
	(6, 118, NULL, 1, 449, 454),
	(7, 118, NULL, 3, 450, 455),
	(8, 118, NULL, 2, 451, 456),
	...
	(104, 117, 'title', 6, 969, 205),
	(105, 117, NULL, 7, 970, NULL);
