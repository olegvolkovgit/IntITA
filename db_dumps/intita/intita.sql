...
) ENGINE=InnoDB AUTO_INCREMENT=955 DEFAULT CHARSET=utf8 COMMENT='Chapters and other lecture''s resources ';

-- Dumping data for table intita.lecture_element: ~708 rows (approximately)
...
-- Dumping data for table intita.lecture_element_lecture_page: ~42 rows (approximately)
...
-- Dumping data for table intita.lecture_page: ~26 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=250 DEFAULT CHARSET=utf8 COMMENT='mark: 0 - failed, 1 - success';
