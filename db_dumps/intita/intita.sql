...
-- Dumping database structure for intita
CREATE DATABASE IF NOT EXISTS `intita` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `intita`;
...
-- Dumping structure for table intita.acc_course_service
DROP TABLE IF EXISTS `acc_course_service`;
CREATE TABLE IF NOT EXISTS `acc_course_service` (
  `service_id` int(10) unsigned NOT NULL COMMENT 'Service code',
  `course_id` int(11) NOT NULL COMMENT 'Course code',
  KEY `service_id` (`service_id`,`course_id`),
  KEY `course_id` (`course_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table intita.acc_course_service: ~5 rows (approximately)
/*!40000 ALTER TABLE `acc_course_service` DISABLE KEYS */;
INSERT INTO `acc_course_service` (`service_id`, `course_id`) VALUES
	(6, 1),
	(7, 18),
	(8, 2),
	(9, 22),
	(10, 21);
/*!40000 ALTER TABLE `acc_course_service` ENABLE KEYS */;


-- Dumping structure for table intita.acc_external_pays
DROP TABLE IF EXISTS `acc_external_pays`;
CREATE TABLE IF NOT EXISTS `acc_external_pays` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Pay code',
  ...
  `summa` decimal(10,2) NOT NULL COMMENT 'Summ of payment',
  `description` varchar(512) NOT NULL COMMENT 'Description of payment',
  PRIMARY KEY (`id`),
  KEY `create_date` (`create_date`,`create_user`,`source_id`,`user_id`,`pay_date`),
  KEY `create_user` (`create_user`),
  KEY `source_id` (`source_id`),
  KEY `user_id` (`user_id`),
  KEY `pay_date` (`pay_date`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Pays from external sources';

-- Dumping data for table intita.acc_external_pays: ~2 rows (approximately)
/*!40000 ALTER TABLE `acc_external_pays` DISABLE KEYS */;
INSERT INTO `acc_external_pays` (`id`, `create_date`, `create_user`, `source_id`, `user_id`, `pay_date`, `summa`, `description`) VALUES
	(2, '2015-08-15 19:31:13', 1, 1, 1, '0000-00-00', 11.00, '111'),
	(3, '2015-08-15 19:58:46', 1, 1, 1, '0000-00-00', 44.00, 'gterwg erth');
/*!40000 ALTER TABLE `acc_external_pays` ENABLE KEYS */;


-- Dumping structure for table intita.acc_external_sources
DROP TABLE IF EXISTS `acc_external_sources`;
CREATE TABLE IF NOT EXISTS `acc_external_sources` (
  `source_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'External source',
  `Name` varchar(512) NOT NULL COMMENT 'Name of source',
  `cash` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Is cash',
  PRIMARY KEY (`source_id`),
  KEY `cash` (`cash`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='External pay sources';

-- Dumping data for table intita.acc_external_sources: ~1 rows (approximately)
/*!40000 ALTER TABLE `acc_external_sources` DISABLE KEYS */;
INSERT INTO `acc_external_sources` (`source_id`, `Name`, `cash`) VALUES
	(1, 'безналичный перевод', 0);
/*!40000 ALTER TABLE `acc_external_sources` ENABLE KEYS */;


-- Dumping structure for table intita.acc_internal_pays
DROP TABLE IF EXISTS `acc_internal_pays`;
CREATE TABLE IF NOT EXISTS `acc_internal_pays` (
  ...
  `agreement_id` int(11) NOT NULL COMMENT 'Agreement',
  `description` varchar(512) NOT NULL DEFAULT 'Pay',
  `summa` decimal(10,2) NOT NULL COMMENT 'Payment summ',
  PRIMARY KEY (`id`),
  KEY `acc_user_id` (`agreement_id`),
  KEY `create_user` (`create_user`),
  KEY `service_id` (`agreement_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Internal pays';

-- Dumping data for table intita.acc_internal_pays: ~2 rows (approximately)
/*!40000 ALTER TABLE `acc_internal_pays` DISABLE KEYS */;
INSERT INTO `acc_internal_pays` (`id`, `create_date`, `create_user`, `agreement_id`, `description`, `summa`) VALUES
	(9, '2015-08-16 13:53:46', 1, 4, 'Pay 1 ', 222.00),
	(10, '2015-08-16 13:54:34', 1, 6, 'Pay 2', 223.00);
/*!40000 ALTER TABLE `acc_internal_pays` ENABLE KEYS */;


-- Dumping structure for table intita.acc_module_service
DROP TABLE IF EXISTS `acc_module_service`;
CREATE TABLE IF NOT EXISTS `acc_module_service` (
  `service_id` int(10) unsigned NOT NULL COMMENT 'Service ID',
  `module_id` int(11) NOT NULL COMMENT 'Module ID',
  KEY `service_id` (`service_id`,`module_id`),
  KEY `module_id` (`module_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Modules as services';

-- Dumping data for table intita.acc_module_service: ~0 rows (approximately)
/*!40000 ALTER TABLE `acc_module_service` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_module_service` ENABLE KEYS */;


-- Dumping structure for table intita.acc_payment_plan
DROP TABLE IF EXISTS `acc_payment_plan`;
CREATE TABLE IF NOT EXISTS `acc_payment_plan` (
  `agreement_id` int(10) unsigned NOT NULL COMMENT 'номер договору',
  `pay_date` date NOT NULL COMMENT 'дата проплаты',
  `summa` decimal(10,0) NOT NULL COMMENT 'сумма проплаты',
  `paid_date` date DEFAULT NULL COMMENT 'дата проплати',
  `cancelled_date` date DEFAULT NULL COMMENT 'дата відміни',
  KEY `agreement_id` (`agreement_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='План проплат';

-- Dumping data for table intita.acc_payment_plan: ~1 rows (approximately)
/*!40000 ALTER TABLE `acc_payment_plan` DISABLE KEYS */;
INSERT INTO `acc_payment_plan` (`agreement_id`, `pay_date`, `summa`, `paid_date`, `cancelled_date`) VALUES
	(6, '0000-00-00', 750, NULL, NULL);
/*!40000 ALTER TABLE `acc_payment_plan` ENABLE KEYS */;


-- Dumping structure for table intita.acc_payment_schema
DROP TABLE IF EXISTS `acc_payment_schema`;
CREATE TABLE IF NOT EXISTS `acc_payment_schema` (
  ...
  `name` varchar(512) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'опис',
  `monthpay` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Схеми проплат';

-- Dumping data for table intita.acc_payment_schema: ~5 rows (approximately)
/*!40000 ALTER TABLE `acc_payment_schema` DISABLE KEYS */;
INSERT INTO `acc_payment_schema` (`id`, `discount`, `pay_count`, `loan`, `name`, `monthpay`) VALUES
	(1, 25.00, 1, 0, 'Проплата наперед', 0),
	(3, 10.00, 2, 0, 'Дві проплати', 0),
	(4, 5.00, 4, 0, '4 проплати', 0),
	(5, 0.00, 6, 24, 'Кредитування на півроку', 1),
	(6, 0.00, 6, 0, 'Оплата за півроку помісячно', 1);
/*!40000 ALTER TABLE `acc_payment_schema` ENABLE KEYS */;


-- Dumping structure for table intita.acc_pays_plans
DROP TABLE IF EXISTS `acc_pays_plans`;
CREATE TABLE IF NOT EXISTS `acc_pays_plans` (
  `internal_pay_id` int(10) unsigned NOT NULL,
  `payment_plan_id` int(10) unsigned NOT NULL,
  KEY `internal_pay_id` (`internal_pay_id`,`payment_plan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table intita.acc_pays_plans: ~0 rows (approximately)
/*!40000 ALTER TABLE `acc_pays_plans` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_pays_plans` ENABLE KEYS */;


-- Dumping structure for table intita.acc_service
DROP TABLE IF EXISTS `acc_service`;
CREATE TABLE IF NOT EXISTS `acc_service` (
  `service_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Service code',
  ...
  `cancelled` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Is cancelled',
  `billable` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Is billable',
  PRIMARY KEY (`service_id`),
  KEY `create_date` (`create_date`,`cancelled`,`billable`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Services ';

-- Dumping data for table intita.acc_service: ~9 rows (approximately)
/*!40000 ALTER TABLE `acc_service` DISABLE KEYS */;
INSERT INTO `acc_service` (`service_id`, `description`, `create_date`, `cancelled`, `billable`) VALUES
	(2, 'Курс Інтернет програміст (РНР) ', '2015-08-15 21:49:35', 0, 1),
	(3, 'Курс Інтернет програміст (РНР) ', '2015-08-15 21:52:25', 0, 1),
	(4, 'Курс Інтернет програміст (РНР) ', '2015-08-15 21:53:28', 0, 1),
	(5, 'Курс Інтернет програміст (РНР) ', '2015-08-15 21:54:56', 0, 1),
	(6, 'Курс Інтернет програміст (РНР) ', '2015-08-15 21:56:43', 0, 1),
	(7, 'Курс Верстальник сайтів (HTML, CSS) ', '2015-08-16 13:47:07', 0, 1),
	(8, 'Курс Інтернет програміст (Java Script) ', '2015-08-16 13:50:54', 0, 1),
	(9, 'Курс FrontEnd розробник (HTML/CSS, JavaScript) ', '2015-08-16 13:54:13', 0, 1),
	(10, 'Курс Побудова успішної ІТ кар’єри ', '2015-08-16 13:54:34', 0, 1);
/*!40000 ALTER TABLE `acc_service` ENABLE KEYS */;


-- Dumping structure for table intita.acc_user_agreements
DROP TABLE IF EXISTS `acc_user_agreements`;
CREATE TABLE IF NOT EXISTS `acc_user_agreements` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'User account',
  ...
  `approval_user` int(11) DEFAULT NULL COMMENT 'user who underscribe agreement',
  `approval_date` date DEFAULT NULL COMMENT 'date when agreement was approved',
  `cancel_user` int(1) DEFAULT NULL COMMENT 'Is agreement cancelled',
  `cancel_date` date DEFAULT NULL COMMENT 'date when agreement was cancelled',
  `close_date` date DEFAULT NULL COMMENT 'Date when agreement should be closed',
  `payment_scheme` int(10) unsigned NOT NULL COMMENT 'Payment scheme',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`,`service_id`,`approval_user`,`payment_scheme`),
  KEY `service_id` (`service_id`),
  KEY `approval_user` (`approval_user`),
  KEY `cancel_user` (`cancel_user`),
  KEY `cancel_date` (`cancel_date`),
  KEY `payment_scheme` (`payment_scheme`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='User accounts';

-- Dumping data for table intita.acc_user_agreements: ~3 rows (approximately)
/*!40000 ALTER TABLE `acc_user_agreements` DISABLE KEYS */;
INSERT INTO `acc_user_agreements` (`id`, `user_id`, `service_id`, `create_date`, `approval_user`, `approval_date`, `cancel_user`, `cancel_date`, `close_date`, `payment_scheme`) VALUES
	(4, 1, 6, '2015-08-16 13:52:54', NULL, NULL, NULL, NULL, NULL, 1),
	(5, 1, 9, '2015-08-16 13:54:13', NULL, NULL, NULL, NULL, NULL, 1),
	(6, 1, 10, '2015-08-16 13:54:34', NULL, NULL, NULL, NULL, NULL, 1);
/*!40000 ALTER TABLE `acc_user_agreements` ENABLE KEYS */;
...
-- Dumping structure for table intita.consultations_calendar
DROP TABLE IF EXISTS `consultations_calendar`;
...
-- Dumping data for table intita.consultations_calendar: ~158 rows (approximately)
/*!40000 ALTER TABLE `consultations_calendar` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `consultations_calendar` ENABLE KEYS */;


-- Dumping structure for table intita.course
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='status: 0 - in develop, 1 - avaliable';

-- Dumping data for table intita.course: ~14 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `lectures` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=254 DEFAULT CHARSET=utf8 COMMENT='isFree ( 0 - pay, 1 - demo lecture)';

-- Dumping data for table intita.lectures: ~132 rows (approximately)
...
INSERT INTO `lectures` (`id`, `image`, `alias`, `idModule`, `order`, `title_ua`, `title_ru`, `title_en`, `idType`, `durationInMinutes`, `idTeacher`, `isFree`, `rate`) VALUES
	...
	(253, NULL, 'lecture11', 1, 11, 'FAWEGAE', 'GAETRGT', 'GTRSG', 1, 60, '1', 0, 0);
/*!40000 ALTER TABLE `lectures` ENABLE KEYS */;


-- Dumping structure for table intita.lecture_element
...
) ENGINE=InnoDB AUTO_INCREMENT=1024 DEFAULT CHARSET=utf8 COMMENT='Chapters and other lecture''s resources ';

-- Dumping data for table intita.lecture_element: ~786 rows (approximately)
...
INSERT INTO `lecture_element` (`id_block`, `id_lecture`, `block_order`, `id_type`, `html_block`) VALUES
	...
	(853, 133, 1, 8, '<p><strong>Що таке система числення</strong></p>'),
	...
	(858, 133, 4, 8, '<p><strong>Непозиційна система числення, змішана система числення.</strong></p>'),
	...
	(1001, 252, 5, 7, '                de'),
	(1002, 252, 6, 12, 'frqfe'),
	(1003, 117, 22, 1, '<p><span class="typ" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\$</span><span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\lim</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">_</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">{</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">n</span><span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\righarrow</span> <span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\infty</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">}</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">f</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">(</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">x</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">)\\</span><span class="typ" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">$</span></p>'),
	(1004, 117, 23, 1, '<p>\\$x=\\frac{1+y}{1+2z^2}\\$</p>'),
	(1005, 117, 24, 1, '<table><tbody><tr><td><pre>\\sum_{i=0}^n i^2 = \\frac{(n^2+n)(2n+1)}{6}\\tag{displayed}</pre></td></tr></tbody></table>'),
	(1006, 117, 25, 1, '<p>\\sum_{i=0}^n i^2 = \\frac{(n^2+n)(2n+1)}{6}\\tag{displayed}</p>'),
	(1007, 117, 26, 1, '<p><span class="typ" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">$</span><span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\lim</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">_</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">{</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">n</span><span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\righarrow</span> <span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\infty</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">}</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">f</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">(</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">x</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">)</span><span class="typ" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">$</span></p>'),
	(1008, 117, 27, 1, '<p>\\<span class="typ" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">$</span><span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\lim</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">_</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">{</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">n</span><span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\righarrow</span> <span class="kwd" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">\\infty</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">}</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">f</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">(</span><span class="pln" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">x</span><span class="pun" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">)\\</span><span class="typ" style="font-family: Menlo, Monaco, monospace, sans-serif; color: inherit; font-size: 12.6000003814697px; line-height: 1.6em; white-space: pre;">$</span></p>'),
	(1009, 117, 28, 1, '<p>\\\\$x=\\frac{1+y}{1+2z^2}\\\\$</p>'),
	(1010, 117, 29, 10, '\\$x=\\frac{1+y}{1+2z^2}\\$ '),
	(1011, 117, 30, 1, '<p>(x=\\frac{1+y}{1+2z^2})</p>'),
	(1012, 117, 31, 1, '<p>This is an in-line \\(\\int\\frac{d\\theta} {1+\\theta^2}= \\tan^{-1} \\theta+C\\) equation. </p>'),
	(1013, 117, 32, 1, '<p>This is an in-line \\(\\int\\frac{d\\theta} {1+\\theta^2}= \\tan^{-1} \\theta+C\\) equation. </p>'),
	(1014, 117, 33, 1, '<p>This is an in-line $\\int \\frac{d\\theta}{1+\\theta^2} = \\tan^{-1}\\theta+C$ equation.</p>'),
	(1015, 117, 34, 10, '\\(\\frac{\\tfrac{452}{25425}}{25424}\\) '),
	(1016, 117, 35, 1, '$\\beta \\varpi \\varpi \\nu \\tau$ '),
	(1017, 117, 36, 1, '<p>text text</p>'),
	(1018, 117, 37, 1, '\\[\\sum \\bigcup_{\\epsilon \\sigma \\tau \\varsigma \\varsigma }^{}\\]\r\n'),
	(1019, 117, 38, 1, '\\[\\varepsilon \\nu \\nu \\rho \\rho \\mu\\]\r\n'),
	(1020, 117, 39, 1, '<p>text </p>\\[\\epsilon \\nu \\rho\\]\r\n'),
	(1021, 117, 40, 1, '<p>dawefcaerf </p>$\\beta \\mu \\mu \\varsigma$ '),
	(1022, 117, 41, 1, '\\[\\inline \\gamma \\kappa \\rho \\varpi \\varrho\\]\r\n'),
	(1023, 117, 42, 1, '<p>асиоуксаиуо </p>$+\\frac{3}{8}$ ');
...
-- Dumping data for table intita.lecture_element_lecture_page: ~297 rows (approximately)
...
-- Dumping data for table intita.lecture_page: ~172 rows (approximately)
...
-- Dumping structure for table intita.messages
...
-- Dumping data for table intita.messages: ~1 912 rows (approximately)
...
-- Dumping structure for table intita.sourcemessages
...
-- Dumping data for table intita.sourcemessages: ~587 rows (approximately)
...
-- Dumping data for table intita.teacher: ~10 rows (approximately)
/*!40000 ALTER TABLE `teacher` DISABLE KEYS */;
INSERT INTO `teacher` (`teacher_id`, `first_name`, `middle_name`, `last_name`, `foto_url`, `subjects`, `profile_text_first`, `profile_text_short`, `profile_text_last`, `readMoreLink`, `email`, `tel`, `skype`, `rate_knowledge`, `rate_efficiency`, `rate_relations`, `user_id`, `rating`, `isPrint`) VALUES
...
-- Dumping structure for table intita.tests_marks
...
INSERT INTO `user` (`id`, `firstName`, `identity`, `network`, `state`, `full_name`, `middleName`, `secondName`, `nickname`, `birthday`, `email`, `password`, `facebook`, `googleplus`, `linkedin`, `vkontakte`, `twitter`, `phone`, `hash`, `address`, `education`, `educform`, `interests`, `aboutUs`, `aboutMy`, `avatar`, `role`, `token`, `activkey_lifetime`, `status`, `reg_time`) VALUES
	...
	(104, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'fbgf@gmail.com', '011c945f30ce2cbafc452f39840f025693339c42', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, 'c5f1a9722575671a9da8efe5cc32e26f76092818', NULL, 0, 0),
	...
	(111, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'nover2579@yandex.ru', '011c945f30ce2cbafc452f39840f025693339c42', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, NULL, NULL, 1, 0),
	...
	(115, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'nnn.basyora2015@gmail.com', '011c945f30ce2cbafc452f39840f025693339c42', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, '3c79de9b46fbbd2d1a58bd6f3b378c7fe019d9ed', NULL, 0, 0),
	(116, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'gfhjdkghfkghdkg@gmail.com', '011c945f30ce2cbafc452f39840f025693339c42', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, '00a07e16dabfafe4507b1751fc68407f3d6fbdbc', NULL, 0, 0),
	...
	(118, 'gjgkgkj', '', '', 0, '', NULL, 'hjghjggjgh', 'hjhjhjhj', '14/02/2012', 'gfhjd@gmail.com', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', '', '', '', '', '', '+38(380)0387125', '', '', '', 'Онлайн/Офлайн', '', '', '', 'noname.png', 1, '8d5ab4dc6bfea2d3bdb64ffe0d82f55d069ea4a7', NULL, 0, 0),
	...
	(120, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'inderella9566cb@rumbler.ru', '011c945f30ce2cbafc452f39840f025693339c42', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, 'dcabda068f44b293f5f4111d0c7d010c11af5177', NULL, 0, 0),
	(121, '', '', '', 0, '', NULL, '', '', '', '22student55@mail.ua', '011c945f30ce2cbafc452f39840f025693339c42', '', '', '', '', '', '', '', '', '', 'Онлайн', '', '', '', '55af57a34461d.jpg', 1, NULL, NULL, 1, 0),
	...
	(123, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'datingstest2015@i.ua', '011c945f30ce2cbafc452f39840f025693339c42', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, NULL, NULL, 1, 0),
	...
	(132, '', '', '', 0, '', NULL, NULL, NULL, NULL, 'abyr@gmail.com', '20eabe5d64b0e216796e834f52d61fd0b70332fc', NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 'Онлайн', NULL, NULL, NULL, 'noname.png', 1, 'e4d4408e9332f3cdc524c27699403cd8419e3b84', NULL, 1, 1439386470),
