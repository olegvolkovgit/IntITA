...
-- Dumping data for table forum.phpbb_acl_groups: ~106 rows (approximately)
...
-- Dumping data for table forum.phpbb_acl_options: ~121 rows (approximately)
...
-- Dumping data for table forum.phpbb_acl_roles_data: ~406 rows (approximately)
...
-- Dumping data for table forum.phpbb_attachments: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_banlist: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_bbcodes: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_bookmarks: ~2 rows (approximately)
...
-- Dumping data for table forum.phpbb_bots: ~45 rows (approximately)
...
-- Dumping data for table forum.phpbb_config: ~296 rows (approximately)
...
INSERT INTO `phpbb_config` (`config_name`, `config_value`, `is_dynamic`) VALUES
	...
	('queue_interval', '60', 0),
	('rand_seed', 'b8bd910be3ae6445e9315ca98ebe982b', 1),
	('rand_seed_last_update', '1438864218', 1),
...
-- Dumping data for table forum.phpbb_confirm: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_disallow: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_drafts: ~1 rows (approximately)
...
-- Dumping structure for table forum.phpbb_ext
...
-- Dumping data for table forum.phpbb_ext: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_extensions: ~66 rows (approximately)
...
-- Dumping data for table forum.phpbb_extension_groups: ~9 rows (approximately)
...
-- Dumping data for table forum.phpbb_forums: ~32 rows (approximately)
...
-- Dumping data for table forum.phpbb_forums_access: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_groups: ~7 rows (approximately)
...
-- Dumping data for table forum.phpbb_icons: ~10 rows (approximately)
...
-- Dumping data for table forum.phpbb_lang: ~2 rows (approximately)
...
-- Dumping data for table forum.phpbb_log: ~117 rows (approximately)
...
-- Dumping structure for table forum.phpbb_login_attempts
...
-- Dumping data for table forum.phpbb_login_attempts: ~0 rows (approximately)
/*!40000 ALTER TABLE `phpbb_login_attempts` DISABLE KEYS */;
/*!40000 ALTER TABLE `phpbb_login_attempts` ENABLE KEYS */;


-- Dumping structure for table forum.phpbb_migrations
...
-- Dumping data for table forum.phpbb_migrations: ~157 rows (approximately)
...
-- Dumping data for table forum.phpbb_moderator_cache: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_modules: ~206 rows (approximately)
...
-- Dumping structure for table forum.phpbb_notifications
...
-- Dumping data for table forum.phpbb_notifications: ~6 rows (approximately)
...
-- Dumping structure for table forum.phpbb_notification_types
...
-- Dumping data for table forum.phpbb_notification_types: ~9 rows (approximately)
...
-- Dumping structure for table forum.phpbb_oauth_accounts
...
-- Dumping data for table forum.phpbb_oauth_accounts: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_poll_options: ~2 rows (approximately)
...
-- Dumping data for table forum.phpbb_posts: ~29 rows (approximately)
...
-- Dumping data for table forum.phpbb_privmsgs: ~1 rows (approximately)
...
-- Dumping data for table forum.phpbb_privmsgs_folder: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_privmsgs_rules: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_profile_fields: ~13 rows (approximately)
...
-- Dumping data for table forum.phpbb_profile_fields_data: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_profile_fields_lang: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_profile_lang: ~26 rows (approximately)
...
-- Dumping data for table forum.phpbb_ranks: ~1 rows (approximately)
...
-- Dumping data for table forum.phpbb_reports: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_reports_reasons: ~4 rows (approximately)
...
-- Dumping data for table forum.phpbb_search_results: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_search_wordlist: ~135 rows (approximately)
...
-- Dumping data for table forum.phpbb_search_wordmatch: ~224 rows (approximately)
...
-- Dumping data for table forum.phpbb_sessions: ~1 rows (approximately)
...
INSERT INTO `phpbb_sessions` (`session_id`, `session_user_id`, `session_last_visit`, `session_start`, `session_time`, `session_ip`, `session_browser`, `session_forwarded_for`, `session_page`, `session_viewonline`, `session_autologin`, `session_admin`, `session_forum_id`) VALUES
	('49e2f617e3ec245236acc70672d15457', 1, 1438862134, 1438862134, 1438865757, '::1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.125 Safari/537.36', '', 'index.php', 1, 0, 0, 0);
...
-- Dumping data for table forum.phpbb_sessions_keys: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_sitelist: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_smilies: ~42 rows (approximately)
...
-- Dumping data for table forum.phpbb_styles: ~1 rows (approximately)
...
-- Dumping structure for table forum.phpbb_teampage
...
-- Dumping data for table forum.phpbb_teampage: ~2 rows (approximately)
...
-- Dumping data for table forum.phpbb_topics_posted: ~29 rows (approximately)
...
-- Dumping data for table forum.phpbb_topics_track: ~20 rows (approximately)
...
-- Dumping data for table forum.phpbb_topics_watch: ~1 rows (approximately)
...
-- Dumping data for table forum.phpbb_users: ~15 rows (approximately)
...
INSERT INTO `phpbb_users` (`user_id`, `user_type`, `group_id`, `user_permissions`, `user_perm_from`, `user_ip`, `user_regdate`, `username`, `username_clean`, `user_password`, `user_passchg`, `user_email`, `user_email_hash`, `user_birthday`, `user_lastvisit`, `user_lastmark`, `user_lastpost_time`, `user_lastpage`, `user_last_confirm_key`, `user_last_search`, `user_warnings`, `user_last_warning`, `user_login_attempts`, `user_inactive_reason`, `user_inactive_time`, `user_posts`, `user_lang`, `user_timezone`, `user_dateformat`, `user_style`, `user_rank`, `user_colour`, `user_new_privmsg`, `user_unread_privmsg`, `user_last_privmsg`, `user_message_rules`, `user_full_folder`, `user_emailtime`, `user_topic_show_days`, `user_topic_sortby_type`, `user_topic_sortby_dir`, `user_post_show_days`, `user_post_sortby_type`, `user_post_sortby_dir`, `user_notify`, `user_notify_pm`, `user_notify_type`, `user_allow_pm`, `user_allow_viewonline`, `user_allow_viewemail`, `user_allow_massemail`, `user_options`, `user_avatar`, `user_avatar_type`, `user_avatar_width`, `user_avatar_height`, `user_sig`, `user_sig_bbcode_uid`, `user_sig_bbcode_bitfield`, `user_jabber`, `user_actkey`, `user_newpasswd`, `user_form_salt`, `user_new`, `user_reminded`, `user_reminded_time`) VALUES
	(1, 2, 1, '00000000000w27wrgg\n\n\n\n\n\n\n\n\n\n\n\n\n\n\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\n\n\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000\ni1cjyo000000', 0, '', 1431076924, 'Anonymous', 'anonymous', '', 0, '', 0, '', 0, 0, 0, '', '2F4M64ETS4', 1438079950, 0, 0, 0, 0, 0, 0, 'uk', 'Europe/Kiev', 'd M Y H:i', 1, 0, '', 0, 0, 0, 0, -3, 0, 0, 't', 'd', 0, 't', 'a', 0, 1, 0, 1, 1, 1, 0, 230271, '', '', 0, 0, '', '', '', '', '', '', 'f370a3f19a8c2ae1', 1, 0, 0),
...
-- Dumping data for table forum.phpbb_user_group: ~17 rows (approximately)
...
-- Dumping structure for table forum.phpbb_user_notifications
...
-- Dumping data for table forum.phpbb_user_notifications: ~188 rows (approximately)
...
-- Dumping data for table forum.phpbb_warnings: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_words: ~0 rows (approximately)
...
-- Dumping data for table forum.phpbb_zebra: ~0 rows (approximately)
