...
INSERT INTO `lecture_element` (`id_block`, `id_lecture`, `block_order`, `type`, `id_type`, `html_block`) VALUES
	...
	(447, 101, 24, 'text', 1, '<p><strong>… </strong></p><p><strong>main()</strong><strong><br></strong><strong>{</strong><strong><br></strong><strong> int n = 0; </strong></p><p><strong> int lim = 50;</strong><strong><br></strong><strong> float s = 0;</strong><strong><br></strong> <strong><br></strong><strong>m1: </strong> <strong>++n;</strong><strong><br></strong><strong> </strong> <strong>if(n &lt; = lim) </strong> <strong>// якщо умова виконується -</strong><strong><br></strong><strong> </strong> <strong>{</strong></p><p><strong>s += n/(n + 5.0);</strong><strong><br></strong><strong> </strong> <strong>goto m1;</strong> <strong>// перехід на оператор, позначений міткою </strong><strong>m1</strong><strong><br></strong><strong> }</strong></p><strong>}</strong>'),
	...
	(514, 149, 9, 'formula', 10, '\\[\\begin{pmatrix} 10& 15& \\\\ 2 8& \\end{pmatrix}\\]\r\n'),
	(515, 149, 10, 'final test', 13, 'апрапораоааооиариповио'),
	(516, 150, 1, 'formula', 10, '\\[\\sum dhgdh\\oint fgbg\\sqrt{ghghg}\\]\r\n'),
	(517, 150, 2, 'text', 1, '<p>ghghdfgdfgfdgsgdhgfhfghsgdhg</p>'),
	(518, 150, 3, 'text', 1, '<p><span style="color: rgb(155, 187, 89); "></span>fxbvjb\n</p>'),
	(519, 98, 1, 'text', 1, '<p><span style="color: rgb(155, 187, 89);">стит ии </span></p>'),
	(520, 149, 11, 'text', 1, '<p>hjhjhjhkkjb</p>'),
	(521, 149, 12, 'text', 1, '<p>  m, m,bnk,bnkbjl nkn;; k;k;</p>'),
	(522, 150, 4, 'text', 1, '<p>gjhkgjkgjl jl</p><hr><p><br></p>'),
	(523, 150, 5, 'label', 8, '<p>jvhkjbl</p>'),
	(524, 150, 6, 'test', 12, 'тест'),
	(525, 150, 7, 'final test', 13, 'Переменная — это:'),
	(526, 150, 8, 'final task', 6, '<p>ывпар</p>'),
...
-- Dumping data for table int_ita_db.letters: ~48 rows (approximately)
...
INSERT INTO `letters` (`id`, `sender_id`, `addressee_id`, `theme`, `text_letter`, `date`, `status`) VALUES
	...
	(48, 22, 38, 'zzx xbvhm', 'fhmj', '2015-07-27 10:16:00', 0);
