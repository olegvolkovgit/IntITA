...
INSERT INTO `messages` VALUES ('227', 'ua', 'персональна сторінка');
...
INSERT INTO `messages` VALUES ('229', 'en', '<P> Then we study the basic principles of programming based on classic computer & rsquo; Books sciences and methodologies algorithmic language, elements of higher and discrete mathematics and combinatorics; data structures, design and analysis of algorithms. \"+\r\n                                  \"<P> After that formed the basis for the transition to modern programming technologies, object-oriented programming, database design.\" +\r\n                                   \"<P> Completion of training by specific application of knowledge to real projects with the assimilation of modern methods and technologies used in IT industry companies.');
...
CREATE TABLE `sourcemessages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8 COMMENT='Table for interface messages (keys).';
