...
-- Dumping data for table int_ita_db.messages: ~686 rows (approximately)
...
-- Dumping data for table int_ita_db.sourcemessages: ~196 rows (approximately)
