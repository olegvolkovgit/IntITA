...
-- Dumping data for table int_ita_db.aa_authorizations: ~54 rows (approximately)
...
-- Dumping data for table int_ita_db.consultationscalendar: ~23 rows (approximately)
