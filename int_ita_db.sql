...
-- Dumping structure for table int_ita_db.consultations_calendar
...
-- Dumping data for table int_ita_db.consultations_calendar: ~109 rows (approximately)
...
-- Dumping data for table int_ita_db.lecture_element: ~701 rows (approximately)
...
-- Dumping data for table int_ita_db.lecture_element_lecture_page: ~3 rows (approximately)
...
-- Dumping data for table int_ita_db.lecture_page: ~1 rows (approximately)
...
-- Dumping data for table int_ita_db.messages: ~1 912 rows (approximately)
...
-- Dumping data for table int_ita_db.sourcemessages: ~587 rows (approximately)
...
-- Dumping data for table int_ita_db.teacher_module: ~37 rows (approximately)
