...
) ENGINE=InnoDB AUTO_INCREMENT=506 DEFAULT CHARSET=utf8 COMMENT='Chapters and other lecture''s resources ';

-- Dumping data for table int_ita_db.lecture_element: ~342 rows (approximately)
...
INSERT INTO `lecture_element` (`id_block`, `id_lecture`, `block_order`, `type`, `id_type`, `html_block`) VALUES
	...
	(476, 145, 2, 'task', 5, 'В трех ящиках 42 кг овощей. В первых двух вместе 27 кг. Сколько кг овощей в первом ящике, если во втором на 4 кг меньше чем в третьем?'),
	...
	(502, 145, 3, 'formula', 10, '\\[\\prod \\varsigma\\]\r\n'),
	(503, 145, 4, 'test', 12, 'cbdsj'),
	(505, 145, 5, 'final test', 13, 'BFISHJVB');
...
-- Dumping data for table int_ita_db.letters: ~45 rows (approximately)
...
INSERT INTO `phpbb_config` (`config_name`, `config_value`, `is_dynamic`) VALUES
	...
	('queue_interval', '60', 0),
	('rand_seed', '9873ce3af7af21bf27b065ab27798e96', 1),
	('rand_seed_last_update', '1437732959', 1),
	('ranks_path', 'images/ranks', 0),
	('read_notification_expire_days', '30', 0),
	('read_notification_gc', '86400', 0),
	('read_notification_last_gc', '1437672201', 1),
...
-- Dumping data for table int_ita_db.sourcemessages: ~562 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COMMENT='Lectures tasks.';
...
-- Dumping data for table int_ita_db.tests: ~40 rows (approximately)
...
-- Dumping data for table int_ita_db.tests_answers: ~175 rows (approximately)
