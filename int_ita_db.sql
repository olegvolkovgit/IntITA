...
) ENGINE=InnoDB AUTO_INCREMENT=603 DEFAULT CHARSET=utf8 COMMENT='Chapters and other lecture''s resources ';

-- Dumping data for table int_ita_db.lecture_element: ~452 rows (approximately)
...
INSERT INTO `lecture_element` (`id_block`, `id_lecture`, `block_order`, `type`, `id_type`, `html_block`) VALUES
	...
	(412, 140, 3, 'task', 5, '<p><strong><em>Завдання: </em>Знайти НСД(16,20,28)</strong></p>'),
...
-- Dumping data for table int_ita_db.tests_answers: ~308 rows (approximately)
...
-- Dumping data for table int_ita_db.tests_marks: ~224 rows (approximately)
