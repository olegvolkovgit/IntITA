...
INSERT INTO `lecture_element` (`id_block`, `id_lecture`, `block_order`, `type`, `id_type`, `html_block`) VALUES
	...
	(225, 100, 9, 'label', 8, '<p><strong>Частина 3. </strong><strong>Правила формального опису мови програмування</strong></p>'),
	...
	(317, 117, 2, 'image', 9, '/images/lecture/89d4ad1124d0010139dd8e5d47700f52.jpg"></p'),
	...
	(340, 117, 4, 'video', 2, '//www.youtube.com/embed/V3x2cHHEaKY"'),
	...
	(368, 100, 11, 'label', 8, '<p><strong>Частина 4. Правила запису програми на мові С</strong></p>'),
	...
	(604, 140, 4, 'text', 1, '<p>Спільним кратним кількох натуральних чисел є число, яке ділиться на всі ці числа без остачі.</p><p><strong>Найменше спільне кратне</strong> (НСК) — найменше натуральне число, яке ділиться на кожне з даних чисел. </p><p>Наприклад, НСК чисел 10 і 15 дорівнює добутку чисел 2, 3 і 5 тобто дорівнює 30.</p><p>Щоб знайти НСК двох чисел, необхідно:</p><ul><li>розкласти дані числа на прості множники;</li><li>скласти добуток усіх простих множників;</li><li>обчислити складений добуток.</li></ul>'),
	(605, 140, 5, 'example', 4, '<p><strong><em>Завдання </em>: Знайти НСК(2,3,4)=12</strong></p>'),
	(606, 140, 3, 'example', 4, '<p><strong><em>Завдання: </em>Знайти НСД(16,20,28)</strong></p>'),
	(608, 140, 6, 'example', 4, '<p><strong><em>Завдання </em>: Знайти НСД і НСК чисел 144, 1008, 1224.</strong></p>'),
	(609, 140, 7, 'text', 1, '<p><strong>Частина 2</strong></p><p>Звичайні дроби</p><p><em>Дробом </em>називається число представлене як результат операції ділення.</p><p><em>Звичайним дробом</em> називається число представлене у вигляді <img src="https://lh4.googleusercontent.com/4fjsbBeQVDE5-X7glizxpgVIs4rEtQ8RlDNYVpIIdqpnZDMdBQbSSqZ9HZhI0diIhNJyx590PPYGvxOGudZfzLZWC0yeIw-najMfpDw_RfHg-kwCCl471BohO2P6rkrTO-guOfki053WGgws" alt="{m}/{n}">, де: m - ціле, n - натуральне. Чисельником називається число або вираз, який стоїть над рискою дробу. Знаменником називається число або вираз, який стоїть під рискою дробу. </p><p>Ціле число можна представити звичайним дробом із знаменником 1.</p><p>Знаменник вказує на скільки рівних частин було розділено щось ціле, а чисельник вказує скільки таких частин було взято. Дріб <img src="https://lh3.googleusercontent.com/onASOrucPOZ5mUWAUnTs1mxBXV-8NY8pAlq1NL7zTZMzU_SKlr-Jy-ghjLcMU6T4Jk_0V-uFfhLp6s_tTkisgMzbpviMTz9eFD49AiaHvSOS0HhkXtCqu2VLykoSHO6Llk5hAF0WFRyx6t-c" alt="{2}/{3}">читається «Дві третіх» або «дві третини».</p><p>Правильні та неправильні дроби </p><p>Якщо у звичайному дробі чисельник менший від знаменника то дріб називається правильним. </p>'),
	(611, 140, 8, 'example', 4, '<p>Наприклад: <img src="https://lh6.googleusercontent.com/UrZeuTRh8W7IITHESOI83rGYsmL7bRei_PcRSuHSyXqLNU64C6YS0s1JBQLPlByccP5ek1l30RBmfYWBcZumDN9t7e-fxKhjh8XEe3LJUOQDWi0AuWkccoVp5YUN36H9WLShuee8E88R9aHC" alt="{4}/{5}">. Якщо у звичайному дробі чисельник більший від знаменника то дріб називається неправильним.</p>'),
	(612, 140, 9, 'example', 4, '<p>Наприклад: <img src="https://lh4.googleusercontent.com/5GvP_vw8F-WM0BboyPd_pGRRgx73U9i31vLPX1__gsvKKzTlx7J9LdA29cfdonWvk79lngJIBzMNcxISC9AgD8g7u5Y5fPS5HRKUX10wp09ddMQPWrmhBoDSgFP6rf7CJRSglF_jOIOeghOI" alt="{7}/{4}">.</p>Неправильні дроби подають у вигляді мішаних чисел.'),
	(613, 140, 10, 'text', 1, '<p>Для того, щоб перетворити неправильний дріб на мішане число, потрібно чисельник поділити на знаменник і окремо записати цілу частину, а остачу записати в чисельнику дробової частини</p>'),
	(614, 140, 11, 'example', 4, '<p>Наприклад, <img src="https://lh3.googleusercontent.com/9DJj1K7H5Koi2I-PeJLZGYtS4XZes9coXt4hByhAZRtiFSOIsUT5E1RgNOwCRRwJfEVKbVuMTShUob0azumCnBigBP2-HikpU2AuNz0R0jwORJjanJbZpcWkH32OY6tLtQREqG-BYubCiLUU" alt="{7}/{4}=1~{3}/{4}">. Читається «одна ціла три четвертих».</p>'),
	(615, 140, 12, 'text', 1, '<p>Якщо у звичайному дробі чисельник рівний знаменнику то дріб можна замінити одиницею. І навпаки одиницю можна замінити дробом у якого чисельник та знаменник рівні.</p>\r\n<p>Два дроби називаються звичайно оберненими, якщо чисельник першого дробу дорівнює знаменнику другого і навпаки. </p><p>Тобто дроби <img src="https://lh6.googleusercontent.com/VW9ABehiRI4iwH5IRkDYd5FHpDaW3XrtZzYmzysJJCQCh8G5U_3IwmgxmJF1fepfJnJ6j6VkPlbtfWMQRm6yMhqKMlYIoaHLoVn6WRlsf2KmKtJjRc2betVPcgOWl25gUuTuqDhIVakRiB4N" alt="{5}/{11}">та <img src="https://lh6.googleusercontent.com/OJHAXs5MczRe50EK3FrunwNd4B0FL8igoDGXET8DxQBDzbGyEeAaiNHeWq60vM6o6VuqkeRUuDHNxq0mkZ4qM3fxFP6EaP64YljXgmb0udR_PIOYQ41jmi2HIt8elV1knAhvl4VxG18GhMj2" alt="{11}/{5}">є взаємно оберненими дробами.</p>'),
	(616, 140, 13, 'text', 1, '<p><strong>Частина 3</strong></p><p>Операції зі звичайними дробами</p><p><em>Розширення дробу</em></p><p>Значення дробу не змінюється, якщо його чисельник та знаменник помножити на одне і те ж число, відмінне від нуля. </p>'),
	(617, 140, 14, 'example', 4, '<p>Приклад: <img src="https://lh3.googleusercontent.com/FIdaqNW8fVDeUh8xhmSyEecYCZ9cXYr_XDlWufRF-9D1Og28mMHW5HOXCyORxUO0s8ILhUzM1ij81XiU6KzTuNBIry8znpKHT8yqSPn462HBsdJ9ATtfuDAyIowCgqAwuFE6xBSCiildM1LE" alt="{2}/{3}={2*4}/{3*4}={8}/{12}"></p>'),
	(618, 140, 15, 'example', 4, '<p><strong></strong></p><p><strong><em>Завдання: </em>Розширити дріб </strong><strong>;</strong></p>'),
	(619, 140, 16, 'text', 1, '<p><em>Спрощення дробу</em></p><p>Значення дробу не змінюється, якщо його чисельник та знаменник поділити на одне і те ж число, відмінне від нуля. </p>'),
	(620, 140, 17, 'example', 4, '<p>Приклад: <img src="https://lh6.googleusercontent.com/aonaKVWSKcS0D5hXgUmQNStZJPuObGjt1IK95Tqh34F_CauYDbuHBQHrTyizEgU9fNM9Jx6soFv2XLsQ7hHmKViMcsdQQaMwb_9KIk9vcFxt4oq6XbhzRgoabcM9CPNhf0ypsBlOQ2fFMZBg" alt="{12}/{16}={12:2}/{16:2}={6}/{8}"></p>'),
	(621, 140, 18, 'example', 4, '<p><strong><em>Завдання: </em>спростити дріб <strong><em></em></strong></strong></p><p><strong><em><br></em></strong></p>'),
	(622, 140, 19, 'text', 1, '<p><em>Скорочення дробу</em>Скороченням дробу називається спрощення дробу на НСД чисельника та знаменника.</p>'),
	(623, 140, 20, 'example', 4, '<p>Приклад: <img src="https://lh5.googleusercontent.com/z11qsgLj4OIyCpWv3lpMCTjAsCN_w5uNxPZbHcjJPrpf3n9YeQZz8tVa1iZvBtuA7r6pdOrxi2uMw-g9Asbcs1yVZ_cbnsH8GOzczUFBBc_YWJegZcpSXQTqQUiHTDnnv6RjSI3qOprdoV5r" alt="{12}/{16}={12:4}/{16:4}={3}/{4}"></p>'),
	(624, 140, 21, 'example', 4, '<p><strong><em>Завдання: </em>Скоротити дріб <strong><em></em></strong></strong></p><p><strong><em><br></em></strong></p>'),
	(625, 140, 22, 'text', 1, '<p>Дріб називається нескоротним, якщо найбільший спільний дільник чисельника та знаменника дорівнює одиниці.</p><p><em>Зведення дробів до спільного знаменника</em></p><p>Спільним знаменником двох дробів називається НСК їх знаменників. </p><p>Щоб звести два дроби до спільного знаменника, потрібно:</p><p>1. знайти НСК двох знаменників; </p><p>2. знайти додаткові множники дробів поділивши знайдене НСК на кожен із знаменників; </p><p>3. помножити чисельник та знаменник кожного дробу (розширити дроби) на отримані додаткові множники. </p>'),
	(626, 140, 23, 'example', 4, '<p>Приклад: <img src="https://lh4.googleusercontent.com/TiqVFi7hZ-wOk4UoPraco1LN2QNOqvzKud6MvmiCWh9uVuPIp99DkGJclx7nMJ2SpUssavVoIofWWIa-xNcJp2TYVhGoYQQDvEYOADVcjpEeoH_VJOp6B5ZbTA-E1A3E3vBgJoMLR_s-FjXG" alt="{1}/{4}~i~{5}/{6};~right~HCK=12;~right"><img src="https://lh3.googleusercontent.com/wrSEcpJO3egzfV5Bh0Z86Y1Qlrr_wsWEWKGbIMFfaFyGw0TQiQmow2dtYborojsE_DiDcPymd8gY2IVGmGesq4-lMaiogbN67J_PXu8yi72TX3L9mmbLsIw5uczj9Ps3_oC9aWGC_31pOSps" alt="{1*3}/{12}~i~{5*2}/{12};~right~3/12~i~10/12"></p>'),
	(627, 140, 24, 'example', 4, '<p><strong><em>Завдання:</em> Звести дроби до спільного знаменника </strong></p>'),
	(628, 140, 25, 'text', 1, '<p><em>Додавання (віднімання) дробів</em></p><p>Сумою (різницею) двох дробів, зі спільними знменниками є дріб, чисельник якого дорівнює сумі (різниці) чисельників, а знаменник дорівнює спільному знаменнику доданків. </p><p>Щоб додати (відняти) два дроби, потрібно: </p><p>1. якщо дроби мають різні знаменики - звести їх до <strong>спільного знаменника</strong>; </p><p>2. додати (відняти) чисельники дробів і результат записати у чисельник; </p><p>3. знаменником записати їх спільний знаменник.</p>'),
	(629, 140, 26, 'example', 4, '<p>Приклад: <img src="https://lh6.googleusercontent.com/rRhXFSS-VS1SNEEM4v1siEArAuUNF0Sle4LRTCORzji0fIkf8SCA10Cjugxb4JbyWWpLFaK0G6mpWIwtGIP3JMP08vuno_IWA2HcrRiQRBTzNrCbbr8XuvkMtYI5QhivpPmaDX8diAhJcI9n" alt="3/7+2/7={3+2}/{7}=5/7">; <img src="https://lh6.googleusercontent.com/RIUt5rV1HpRCOPZOk0lkco9-yoNkM9kQumd56I2abbuvcinogUMaHU3rho57EnRC7u5MfRtW8O4iXiZ7cEJmV8QNzAptnOlQCZB07b-bq5i9VFkOT9Tn1yz5tHQBDOL5Fi3OxuAKDyLKyCM4" alt="~~~3/7-2/7={3-2}/{7}=1/7"></p>'),
	(630, 140, 27, 'example', 4, '<p><strong><em>Завдання: </em>Виконати дії </strong></p>'),
	(631, 140, 28, 'text', 1, '<p><em>Множення дробів</em></p><p>Добутком двох дробів є дріб, чисельник якого дорівнює добутку чисельників, а знаменник — добутку знаменників.</p><p>Щоб помножити два дроби, потрібно:</p><p>1. перемножити чисельники і результат записати у чисельник;</p><p>2. перемножити знаменники і результат записати у знаменник.</p>'),
	(632, 140, 29, 'text', 1, '<p>Приклад: <img src="https://lh4.googleusercontent.com/n4646x4hLK7iLOYj2fwU--0105iQ7No20CQtl3nJ-rlBNO5JCeii9IBVKCmEp7m7O7Hqj4qHJGURWvRD0c7zU8XQ_rkhV1QrjfwvBaZlCF2qki0R1mY8B-nG7f8Q9lok50l7eVwO0Kvi7wlz" alt="{{1}/{3}}*{{4}/{5}}={1*4}/{3*5}=4/15"></p>'),
	(633, 140, 30, 'example', 4, '<p><strong><em>Завдання: </em>Виконати дії </strong></p>'),
	(634, 140, 31, 'text', 1, '<p><em>Ділення дробів</em></p><p>Часткою двох дробів є добуток першого дробу на обернений другий. </p><p>Щоб поділити два дроби, потрібно:</p><p>1. другий дріб замінити оберненим до нього (у другому дробі поміняти місцями чисельник та знаменник);</p><p>2. помножити отримані дроби.</p>'),
	(635, 140, 32, 'text', 1, '<p>Приклад: <img src="https://lh5.googleusercontent.com/nBzK3N9c-C8EMu0sfuF8f6PEt6ivYP-3P1uWuPJ3eWApg82CIULv3jlKW41uw31EHIIoMkUvAV_-cDjSF0-70IYh6Chy8NYuYdXIn_pBVoF9rQgPYvO5db8UBWXsk4r1p6xY_u23v_68wwmk" alt="{{1}/{3}}:~{{4}/{5}}={1/3}*{5/4}=5/12"></p>'),
	(636, 140, 33, 'example', 4, '<p><strong><em>Завдання: </em>Виконати дію </strong></p>'),
	(637, 140, 34, 'example', 4, '<p><em>Порівняння звичайних дробів</em></p>З двох дробів із однаковим знаменником більшим є той в якого більший чисельник Приклад: <img src="https://lh4.googleusercontent.com/uU7pYVRiixnbRFF5X3h-nHfhLXFuUUCL7-67UrXzuU4ykUQzb6DB1k3D4vlpCLmir9Ib4KVwuVZqZiJ7-_ZWSmssmypv-bChLVyu9hPfMkBdAFEPhNKE3p78E1q9vCjH-jSP_OBofds_boSN" alt="5/7 data-verified=" redactor"="">3/7"&gt; З двох дробів із однаковим чисельником більшим є той в якого менший знаменник.'),
	(638, 140, 35, 'example', 4, '<p>Приклад: <img src="https://lh4.googleusercontent.com/gI2YNXAwK0y9wFlSk26UavIQRxvik2K5YWdgvTOBaOEi3LfBKtpBQ6HstiSQtk1pXbFrR5Cir4Hy23kIdOsR2gbxGSb7FdeksjuuGHDFUPODeM6ZROIxsPtuAl-Ls-fQULLHzCOz8OczhoKS" alt="5/7 data-verified=" redactor"="">5/9"&gt;</p>'),
	(639, 184, 1, 'formula', 10, '\\[\\beta \\mu \\mu \\tau \\rho \\iota \\nu \\tau \\rho \\nu \\rho \\varsigma\\]\r\n'),
	(640, 140, 36, 'example', 4, '<p><strong><em>Завдання: </em>Виконати дії <img src="https://lh4.googleusercontent.com/IgA3D_kD_YO34QtSZ1PsbQx-Bk8quAGoK9JsL-oCl7g9ghv16Jb1IEOh79qbG_Ot3fXAgn3TKIP-Uw2_EZ_3H-P1GMmEw9XNgfv9ifjivjiW5Yy61lcPgC9fLlvDskvrOXBmvbS8KUeCF2vj" width="167" height="53" style="width: 167px; height: 53px;"></strong></p>'),
	(641, 140, 37, 'text', 1, '<p><strong>Частина 3</strong></p><p><strong>Десяткові дроби</strong></p><p>Десятковим дробом називається спосіб представлення чисел у вигляді послідовності цифр розділених комою (у деяких країнах крапкою). </p><p>Наприклад дріб 12,345 читається "дванадцять цілих триста сорок п\'ять тисячних".</p><p>В початок цілої частини і/або в кінець дробової частини можна дописувати скільки завгодно нулів. </p><p>Приклад: 00012,43500.</p><p>Скінченним десятковим дробом називається дріб, який містить скінченну кількість цифр після коми. Приклад: 12,435. </p><p>Нескінченним десятковим дробом називається дріб, який не містить скінченної кількості цифр після коми. Приклад: 12,435... </p><p>При <strong>додаванні (відніманні) десяткових дробів</strong> числа записують так, щоб однакові розряди були записані один під одним, а кома – під комою, і додають (віднімають) як натуральні числа</p><p>Щоб <strong>помножити один десятковий дріб на інший</strong>, потрібно виконати множення, не звертаючи уваги на коми, і в отриманому добутку відокремити праворуч комою стільки цифр, скільки їх стоїть після коми в обох множниках разом. Наприклад, <img src="https://lh6.googleusercontent.com/R3TeC0wJW7ovtSOuq_0rwbmzlV4Ep7tpcQa2COLuwbHvFOnRh7U5Q_t-1M1nmwSqupLvq81MFX0MER_ZOIQakJAWzmkSQfqkztpsnz-HmVdrgmmefOkYmLKUl6D-mOMeALE6yaP7DIHsklvw">.</p><p>Щоб <strong>помножити десятковий дріб на 10, 100, 1000 і т.д.,</strong> необхідно в цьому дробі перенести кому вправо на стільки цифр, скільки нулів у множника (дописавши у випадку необхідності до дробу праворуч певне число нулів). Наприклад: <img src="https://lh6.googleusercontent.com/W5VCSo6_rDyCu_UZJMHWw3RuKNGppo826HhdBD-OnOxljlQNKzTTPAzXNl_Nwpe6E0Y1uszTsDYIff59eDvhnSmv4UNK4sVdWM04JUl1-N-nfEBGr_3s_uMg2GCGc89V-I2NxDkL8xPMyBau">; <img src="https://lh3.googleusercontent.com/n-nNbWNto0_3HIB0TKKHx4YfjeH9agbYQEI_xDOBSTt6BPGdrNG4CGs2B0AMqdvGJxt-9nXRa5_64u6NjygKKF6AqNeLVR0V8LhJYJbYauaC2W435x1Voyx4i5IZeyIla3GaziYH9kM8fwjQ">.</p><p><strong>Ділення десяткового дробу на натуральне число</strong> виконується так само, як ділення натурального числа на натуральне, але кому в частці ставлять після того, як закінчено ділення цілої частини.</p><p>Розглянемо тепер <strong>ділення десяткового дробу на десятковий дріб</strong>. Нехай треба поділити 8,316 на 2,31. Для цього і в діленому, і в дільнику перенесемо кому вправо на стільки цифр, стільки їх є після коми в дільнику (в даному прикладі на дві). Іншими словами, помножимо ділене і дільник на 100 – від цього частка не зміниться. Тоді треба поділити дріб 831,6 на натуральне число 231, тобто задача зводиться до вже знайомого випадку.</p><p>Щоб <strong>поділити десятковий дріб на </strong><strong><img src="https://lh5.googleusercontent.com/f_QuRJkjBLfTJFHUUJseF8rdK6iEMAdvjS-qb9TkY3D_uVxMsmcfeQ0kIlGf5hm6upxBL2AXuyvzCTjhxaf8rDSMlDOVh8ng_brbu4X6VExviHNl36Yam0QqGkdja7bfDxywfXHiP_3v_EZY"></strong>, треба в цьому дробі перенести кому на <em>п</em> цифр вліво (при цьому у випадку необхідності зліва приписати потрібне число нулів).</p><p>Як для натуральних чисел ділення не завжди можна виконати, так його не завжди можна виконати й для десяткових дробів</p>'),
