...
CREATE TABLE IF NOT EXISTS `roles` (
  ...
  `description` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='List of teachers roles.';

-- Dumping data for table int_ita_db.roles: ~6 rows (approximately)
...
-- Dumping data for table int_ita_db.teacher_module: ~24 rows (approximately)
