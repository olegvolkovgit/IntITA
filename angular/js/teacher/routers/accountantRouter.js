...
angular
    .module('accountantRouter', ['ui.router']).config(function ($stateProvider) {
        ...
        $stateProvider
            ...
            .state('accountant/writtenAgreementView/:id', {
                url: "/accountant/writtenAgreementView/:id",
                cache: false,
                templateUrl: function ($stateParams) {
                    return accountantUrl + "template/writtenAgreementView/" + $stateParams.id;
                }
            })

            .state('accountant/writtenAgreementUpdate/:id', {
                url: "/accountant/writtenAgreementUpdate/:id",
                cache: false,
                templateUrl: function ($stateParams) {
